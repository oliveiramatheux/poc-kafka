# Kafka example project with NodeJS.

- 💬 Description and objective: Make a Kafka example project with NodeJS.

#### 🚧 Project status 🚀 In progress, started in 18/11/2022 🚧
...
```bash
yarn
Create a ".env" file like as the "test.env" file in the project root with your settings
yarn start
```
